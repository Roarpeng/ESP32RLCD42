...
set "PATH=C:\Espressif\tools\cmake\4.0.3\bin;C:\Espressif\tools\ninja\1.12.1;C:\Espressif\tools\xtensa-esp-elf\esp-15.2.0_20251204\xtensa-esp-elf\bin;C:\Espressif\tools\python\v6.0.1\venv\Scripts;%PATH%"
cd /d C:\Users\roarp\Desktop\TMP\Code\AICode\ESP32\ESP32RLCD42
echo ===== Building ESP32RLCD42 =====
...
echo ===== Build OK! Flashing to COM3 =====
